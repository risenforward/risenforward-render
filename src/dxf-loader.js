if (typeof THREE === 'undefined' && typeof require !== 'undefined') { var THREE = require('three') }

if (typeof DxfParser === 'undefined' && typeof require !== 'undefined') { var DxfParser = require('dxf-parser') }
 ...
 */
const BulgeGeometry = function (startPoint, endPoint, bulge, segments) {
  var vertex, i,
    center, p0, p1, angle,
    radius, startAngle,
    thetaAngle
...
export class DXFLoader {
  ...
  parse (data) {
    ...
    function drawLine (entity, data) {
      ...
      var material; var lineType; var vertex; var startPoint; var endPoint; var bulgeGeometry

      var bulge; var i; var line
    ...
    function drawSolid (entity, data) {
      var material; var mesh; var verts
